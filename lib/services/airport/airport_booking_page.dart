...
const double terminalCharge = 7.0;
...
class _AirportBookingPageState extends State<AirportBookingPage> {
  ...
  double getFare(String vehicle) {
    ...
    double fare = perMile * tripMiles! + terminalCharge;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Airport / Hotel Transfer")),
      body: Column(
        children: [
          Expanded(
                                ...
                                Icon(
                                  v == "Standard"
                                      ...
                                      : v == "Executive"
                                          ...
                                          : Icons.directions_bus, // use bus as SUV alternative
                                  size: 24,
                                ),
  ...
  LatLng awaitGeocode(String address) {
    ...
    // In production you should await properly
